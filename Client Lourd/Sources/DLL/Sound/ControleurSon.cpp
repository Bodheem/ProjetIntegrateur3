...
void ControleurSon::jouerSon(char* sName, bool pause)
{
	...
	/*if (std::string(sName) == "Quiet-Tension"){
		soundTable_[17].second.second->setPaused(true);
		soundTable_[17].second.second->setVolume(0.05f);
		soundTable_[17].second.second->setPaused(false);
	}*/
	//setVolumeLimiter();
}
...
void ControleurSon::ajusterVolume(char* sName, float percent)
{
	...
	//soundTable_[i].second.second->setVolume(percent);
		...
		soundTable_[i].second.second->setPaused(true);
		soundTable_[i].second.second->setVolume(percent);
		soundTable_[i].second.second->setPaused(false);

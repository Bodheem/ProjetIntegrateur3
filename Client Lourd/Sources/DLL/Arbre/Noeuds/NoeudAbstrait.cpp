...
/// @brief Ne fait qu'initialiser les variables membres de la classe.
/// @param[in] type: Le type du noeud.
/// @return Aucune (constructeur).
////////////////////////////////////////////////////////////////////////
NoeudAbstrait::NoeudAbstrait(const std::string& type) : vitesse_{ 0.0, 0.0, 0.0 }
{
	type_ = type;
	modele_ = nullptr;
	colorShift_ = false;
	...
	transparent_ = false;
	impossible_ = false;
	animer_ = FacadeModele::obtenirInstance()->obtenirAnimation();
}
...
void NoeudAbstrait::appliquerAfficher() const
{
	...
	ControleurNuanceurs::obtenirInstance()->assignerColorShift(colorShift_);
...
///
////////////////////////////////////////////////////////////////////////
int NoeudAbstrait::getColorShift()
{
	return colorShift_;
}
...
///
////////////////////////////////////////////////////////////////////////
void NoeudAbstrait::setColorShift(int colorShift)
{
...
/// @param[in] numero Numero assigne au noeud.
////////////////////////////////////////////////////////////////////////
int NoeudAbstrait::obtenirNumeroUnique() const
{
	return numeroUnique_;
}
...
/// @param[in] numero Numero assigne au noeud.
////////////////////////////////////////////////////////////////////////
void NoeudAbstrait::assignerNumeroUnique(int numero)
{
	numeroUnique_ = numero;
}
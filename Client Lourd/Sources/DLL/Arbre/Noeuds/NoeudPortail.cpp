...
void NoeudPortail::animer(float temps)
{
	...
	if (diff > 10)
	{
		...
		setDebug(FacadeModele::obtenirInstance()->obtenirConfiguration()[11] == 1);
	}
	else
	{
		estActive_ = false;
		enfants_[0]->assignerAffiche(false);
		setDebug(false);
	}
}
...
/// @return Un vecteur<glm::dvec3> dont le seul element a le rayon de l'objet comme premiere coordonnee.
////////////////////////////////////////////////////////////////////////
...
{
	if (bille->obtenirPortailDorigine() != this && estActive_)
	{
		FacadeModele::obtenirInstance()->obtenirControleurSon()->jouerSon("portal");
...
////////////////////////////////////////////////////////////////////////
/// @fn void NoeudPortail::setStartingDisable(std::clock_t starting)
/// @brief Cette fonction assigne le moment ou on commence a desactiver les portails
/// @param[in] starting le temps
/// @return Aucun.
////////////////////////////////////////////////////////////////////////
void NoeudPortail::setStartingDisable(std::clock_t starting)
{
	start_ = starting;
}
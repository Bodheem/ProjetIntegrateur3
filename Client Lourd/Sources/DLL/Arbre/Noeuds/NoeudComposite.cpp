...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::assignerAnimer(bool animer)
///
/// @param[in] animer : valeur a mettre dans animer_ pour lui-meme et
///						ses enfants.
///
/// @return Aucun.
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::assignerAnimer(bool animer)
{
	animer_ = animer;
	for (auto enfant : enfants_)
		enfant->assignerAnimer(animer);
}

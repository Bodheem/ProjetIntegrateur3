...
/// @brief Ne fait qu'assigner que ce noeud n'est pas selectionnable.
...
////////////////////////////////////////////////////////////////////////
/// @fn ArbreRendu::~ArbreRendu()
/// @brief Detruit les usines des noeuds de l'arbre.
...
/// @brief Cette fonction permet de creer un nouveau noeud, sans l'ajouter
...
/// @brief Cette fonction permet d'ajouter un nouveau noeud dans l'arbre de rendu.
/// @param[in] typeParent       : Le type du parent du nouveau noeud.
/// @param[in] typeNouveauNoeud : Le type du nouveau noeud.
/// @return Le noeud nouvellement cree.
////////////////////////////////////////////////////////////////////////
NoeudAbstrait* ArbreRendu::ajouterNouveauNoeud(const std::string& typeParent, const std::string& typeNouveauNoeud)
{
...
/// @return Aucune (destructeur).
////////////////////////////////////////////////////////////////////////
void ArbreRendu::libererUsines()
{
	auto iter = usines_.begin();
	while (iter != usines_.end())
	{
		delete iter->second;
		iter->second = nullptr;
		++iter;

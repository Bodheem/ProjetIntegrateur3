...
public:
   ...
   /// Nettoyer la mémoire alloués par les usines
   void libererUsines();
   ...
   NoeudAbstrait* ajouterNouveauNoeud(const std::string& nomParent, const std::string& typeNouveauNoeud);
...
///
////////////////////////////////////////////////////////////////////////
inline void ArbreRendu::ajouterUsine(const std::string& type, const UsineNoeud* usine)
{
	auto iter = usines_.find(type);
